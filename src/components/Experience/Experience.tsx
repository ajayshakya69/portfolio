...
const experiences = [
  ...
  },
  {
    ...
    logo: "/assets/krip-logo.svg",
    description:
      "Worked as a Full Stack Developer on Krivisio, a Project Management platform designed for Project Manager and Developer to manage Projects, Tasks, and Meeting efficiently. Developed and optimized key features, integrated Supabase for authentication and storage, containerized services using Docker, and ensured database reliability with PostgreSQL and MongoDB. Delivered a production-ready, scalable solution through close collaboration with the client.",
    technologies: [
      "Next.js",
      "NestJS",
      "Supabase",
